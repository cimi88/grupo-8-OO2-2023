...
public class EventoConverter {
	...
	public Evento modelToEntity(EventoModelo eventoModelo) {
		return new Evento(eventoModelo.getId(), dispositivoAspersorRepository.findById(eventoModelo.getIdDispositivo()) ,eventoModelo.getDescripcionEvento(), eventoModelo.getFechaHoraRegistro());
	}
